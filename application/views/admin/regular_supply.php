...
<br>
					<h1>Regular Supply
						...
						<br>
						<div class="float-left"><a href="javascript:void(0);" class="btn btn-success" data-toggle="modal" data-target="#regAdd"><i class="fa fa-plus"></i> Add New</a> 
	...
	<br>
				<div class="card col-12">
					...
					<div class="card-body col-md-12">
						<div class="row">
							<div class="col-md-12">
								<table id="viewRegSupply" class="table table-striped table-bordered" style="width: 100%">
									<thead>
										<tr >
				...
				<!-- MODAL ADD -->
				<form>
					<div class="modal fade" id="regAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add New Regular Supply Document</h5>
                  ...
                  <div class="modal-body">
                        <div class="form-group row">
                          <input type="hidden" name="regSupply_ID" id="regSupply_ID" class="form-control">
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Date</label>
                            <div class="col-md-10">
                              <input type="date" name="regSupDate" id="regSupDate" class="form-control" placeholder="Date" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Recipient</label>
                            <div class="col-md-10">
                              <input type="text" name="regSupRecipient" id="regSupRecipient" class="form-control" placeholder="Recipient" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Quantity</label>
                            <div class="col-md-10">
                              <input type="number" name="regSupQuantity" id="regSupQuantity" class="form-control" placeholder="Quantity" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Description</label>
                            <div class="col-md-10">
                              <textarea type="text" name="regSupDescript" id="regSupDescript" class="form-control" placeholder="Description" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Receiver</label>
                            <div class="col-md-10">
                              <input type="text" name="regsupRecevier" id="regsupRecevier" class="form-control" placeholder="Receiver" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Amount</label>
                            <div class="col-md-10">
                              <input type="text" name="regSupAmount" id="regSupAmount" class="form-control" placeholder="Amount" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <!-- <label class="col-md-2 col-form-label">Status</label> -->
                            <div class="col-md-10">
                              <input type="hidden" name="regSupStat" id="regSupStat" class="form-control" placeholder="Status" required value="Pending">
                            </div>
                        </div>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" name="save" type="submit" id="btn_save_reg" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
